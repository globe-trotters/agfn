angular.module('myApp').controller('totalExpensesGraphCtrl', function($scope) {
...
function showChart() {
    ...
    var chart = d3.select('#chart2'),
        ...
        yRange = d3.scale.linear().range([height - margins.top, margins.bottom]).domain([0,20000]),
    ...
    chart.selectAll('rect2')
        ...
        .attr('height', 0)
        .attr('y', yRange(1))
        .transition().duration(2000).delay(function(d, i) { return i * 300; })
